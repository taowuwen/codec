...
/* cfg for ctrl */
#define CFG_ctrl_bind_addr		"ctrl.bind.addr"
#define CFG_ctrl_bind_port		"ctrl.bind.port"
#define CFG_log_level			"ctrl.log.level"

/* cfg for net */
#define CFG_net_filter_rule		"net.filter.rule"

/*
   cfg for http config
 */
#define CFG_net_http_rule		"net.http.rule"

/*
   cfg for e6wifi config 
 */
#define CFG_out_e6wifi_ftp_port		"out.e6wifi.ftp.port"
#define CFG_out_e6wifi_ftp_addr		"out.e6wifi.ftp.addr"
#define CFG_out_e6wifi_ftp_user		"out.e6wifi.ftp.user"
#define CFG_out_e6wifi_ftp_pass		"out.e6wifi.ftp.pass"
#define CFG_out_e6wifi_ftp_home		"out.e6wifi.ftp.home"
#define CFG_out_e6wifi_ftp_sh		"out.e6wifi.ftp.sh"

#define CFG_out_e6wifi_policy_max_fl_sz		"out.e6wifi.policy.max_file_size"
#define CFG_out_e6wifi_policy_max_tm_upload	"out.e6wifi.policy.max_timeout_upload"

#define CFG_net_filter_e6wifi_citycode	"net.filter.e6wifi.citycode"
