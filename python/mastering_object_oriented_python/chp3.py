...
#n.attribute = "value"
#
#print("n.attribute = {}".format(n.attribute))
#del n.attribute
...
#			return str(self)
#
#		return ", ".join("{0:{fs}}".format(c, fs=format_spec) for c in self.card)
#
#
...
#
#	def split(self, deck):
#		if not self.card[0].rank == self.card[1].rank:
#			print("not a split hand")
#			return None
#
#
#		assert self.card[0].rank == self.card[1].rank
#
#
#
#		c1 = self._cards[-1]
