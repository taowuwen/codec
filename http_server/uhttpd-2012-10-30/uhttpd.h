...
#define DV(...) _uh_log(LOG_VERBOSE, __FUNCTION__, __LINE__, __VA_ARGS__)
#define D(...)  _uh_log(LOG_TRACE, __FUNCTION__, __LINE__, __VA_ARGS__)
...
struct client {
	...
	/*
	 * updated by tww 2013 12 29
	 * */
	int file;

	/*
	 * updated by tww 2/23/2014
	 *
	 * for Content-Range control
	 * */
