...
char *m_memdup(u8block_t *b, u32_t len, const char *fl, unsigned l);
...
#define Realloc(A,B)	m_relloc((char *)A, B, __FILE__, __LINE__)
...
void m_free(char *b);
char *m_memdup(u8block_t *b, u32_t len);

#define Malloc		m_malloc
#define Realloc(A,B)	m_relloc((char *)A, B)
#define Free(A)		m_free((char *)A)
#define Assert(A)
