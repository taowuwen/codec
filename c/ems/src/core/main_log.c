...
ems_int main_log(ems_int cmd, ems_int argc, ems_char **argv)
{
	ems_int      rtn;
	json_object *req, *obj;
	...
	do {
		...
		{
			obj = json_object_object_get(req, "loglevel");
			if (!obj) break;

			ems_json_reset_key(obj, req, "loglevel");
		}
