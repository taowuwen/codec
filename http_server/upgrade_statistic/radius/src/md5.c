...
/*
   updated by taowuwen@mail.maipu.com

   referenced by : http://cseweb.ucsd.edu/~mihir/papers/rfc2104.txt, page 9
 */

void rc_hmac_md5_calc(unsigned char *input, size_t input_len, 
