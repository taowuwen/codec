...
#ifdef DEBUG
#define EMS_SESSION_ACCEPTED_TIMEOUT	10000
#define EMS_SESSION_NORMAL_TIMEOUT	10000
#else
#define EMS_SESSION_ACCEPTED_TIMEOUT	5000
#define EMS_SESSION_NORMAL_TIMEOUT	5000
#endif
